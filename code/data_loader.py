...
class AgePredictionDataLoader:
    ...
    def _load_labels(self):
        ...
        labels_dict = dict(zip(df["file_name"], zip(df["apparent_age_avg"], df["apparent_age_std"])))
        return labels_dict
            ...
            if img_name.endswith("_face.jpg"):
                ...
                if csv_name in self.labels:
                    ...
                    try:
                        ...
                        avg_age, std_age = self.labels[csv_name]
                        label_tensor = tf.convert_to_tensor([avg_age, std_age], dtype=tf.float32)

                        yield img_array, label_tensor
    ...
    def get_dataset(self):
        dataset = tf.data.Dataset.from_generator(
            ...
            output_signature=(
                ...
                tf.TensorSpec(shape=(2,), dtype=tf.float32)  # 2 values: mean, std
            )
